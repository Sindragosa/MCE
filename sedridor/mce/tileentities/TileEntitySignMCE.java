...
public class TileEntitySignMCE extends TileEntitySign
{
	...
	public void writeToNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		par1NBTTagCompound.setBoolean("Redstone", this.redStone); // -- MCE
	}
	...
	public void readFromNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		// ------------------------------------------------ MCE
		if (par1NBTTagCompound.hasKey("Redstone"))
		{
			this.redStone = par1NBTTagCompound.getBoolean("Redstone");
		}
