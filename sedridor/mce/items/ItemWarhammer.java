...
public class ItemWarhammer extends ItemSword
{
	...
	private static Block[] blocksEffectiveAgainst = new Block[] {Block.cobblestone, Block.stoneDoubleSlab, Block.stoneSingleSlab, Block.stone, Block.sandStone, Block.cobblestoneMossy, Block.ice, Block.netherrack, Block.rail, Block.railDetector, Block.railPowered,
	...
	public ItemWarhammer(int par1, EnumToolMaterial par2EnumToolMaterial)
	{
		...
		this.weaponDamage = 5 + par2EnumToolMaterial.getDamageVsEntity();
	}
	...
	{
		Block[] var3 = ItemWarhammer.blocksEffectiveAgainst;
