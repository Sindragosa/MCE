...
public class ItemStaffLightning extends Item
{
	public int timer;

	public ItemStaffLightning(int par1)
	{
		super(par1);
		this.setMaxDamage(43);
		this.timer = 0;
	}
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		if (this.timer == 0)
		{
			EntityLightball var4 = new EntityLightball(par2World, par3EntityPlayer, 2.0F);
