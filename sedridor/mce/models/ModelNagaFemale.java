...
public class ModelNagaFemale extends ModelHumanFemale
{
	ModelRenderer leg;
	ModelRenderer leg2;
	ModelRenderer leg3;
	...
	public ModelNagaFemale()
	{
		this(0.0F);
	}

	public ModelNagaFemale(float par1)
	{
		this(par1, 0.0F, 64, 32);
	}

	public ModelNagaFemale(float par1, float par2, int par3, int par4)
	{
		super(par1, par2, par3, par4, 1);
