...
public class ModelHumanFemale extends ModelBiped
{
	...
	private int breastsType = 0;

	public ModelHumanFemale()
	{
		this(0.0F);
	}

	public ModelHumanFemale(float par1)
	{
		this(par1, 0.0F, 64, 32, 2);
	}

	public ModelHumanFemale(float par1, float par2, int par3, int par4, int par5)
	{
