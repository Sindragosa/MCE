...
public class ModelRedDragon extends ModelBase
{
	...
	{
		GL11.glPushMatrix();
		EntityRedDragon var8 = (EntityRedDragon)par1Entity;
		...
		for (int var19 = 0; var19 < 5; ++var19)
		{
			...
			var11 = (float)(var11 + Math.sin(this.neck.rotateAngleX) * 10.0D);
			var12 = (float)(var12 - Math.cos(this.neck.rotateAngleY) * Math.cos(this.neck.rotateAngleX) * 10.0D);
			var13 = (float)(var13 - Math.sin(this.neck.rotateAngleY) * Math.cos(this.neck.rotateAngleX) * 10.0D);
		...
		this.head.rotateAngleZ = -this.updateRotations(var23[0] - var17) * (float)Math.PI / 180.0F * 1.0F;
		...
		for (int var25 = 0; var25 < 12; ++var25)
		{
			...
			this.neck.rotateAngleZ = this.updateRotations(var23[0] - var17) * (float)Math.PI / 180.0F * var14;
			this.neck.rotationPointY = var11;
			this.neck.rotationPointZ = var12;
			this.neck.rotationPointX = var13;
			var11 = (float)(var11 + Math.sin(this.neck.rotateAngleX) * 10.0D);
