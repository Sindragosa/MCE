...
public class ModelGoblinShaman extends ModelBase
{
	...
	public ModelGoblinShaman()
	{
		...
		this.bipedRightLeg.addBox(-1.0F, 0.0F, -2.0F, 3, 6, 4, 0.0F);
		this.bipedRightLeg.setRotationPoint(-2.0F, 18.0F, -1.0F);
		this.bipedRightLeg.rotateAngleX = 0.0F;
		this.bipedRightLeg.rotateAngleY = 0.0F;
		this.bipedRightLeg.rotateAngleZ = 0.0F;
		this.bipedRightLeg.mirror = false;
		this.bipedLeftLeg = new ModelRenderer(this, 30, 20);
		this.bipedLeftLeg.addBox(-1.0F, 0.0F, -2.0F, 4, 6, 4, 0.0F);
		this.bipedLeftLeg.setRotationPoint(1.0F, 18.0F, -1.0F);
