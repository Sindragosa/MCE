...
public class RenderGoblin extends RenderLiving
{
	...
	public RenderGoblin(ModelGoblin par1ModelGoblin, float par2)
	{
		super(par1ModelGoblin, par2);
		this.modelBipedMain = par1ModelGoblin;
	}

	public void render(EntityGoblin par1EntityGoblin, double par2, double par4, double par6, float par8, float par9)
	{
	...
	{
		this.render((EntityGoblin)par1EntityLiving, par2, par4, par6, par8, par9);
	}
	...
	{
		this.render((EntityGoblin)par1Entity, par2, par4, par6, par8, par9);
	}
}
