...
public class RenderGoblinNinja extends RenderLiving
{
	protected ModelGoblin modelBipedMain;

	public RenderGoblinNinja(ModelGoblin par1ModelGoblin, float par2)
	{
		super(par1ModelGoblin, par2);
		this.modelBipedMain = par1ModelGoblin;
	}

	public void render(EntityGoblinNinja par1EntityGoblinNinja, double par2, double par4, double par6, float par8, float par9)
	{
		super.doRenderLiving(par1EntityGoblinNinja, par2, par4, par6, par8, par9);
	}

	@Override
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
	{
		this.render((EntityGoblinNinja)par1EntityLiving, par2, par4, par6, par8, par9);
	}
	...
	{
		this.render((EntityGoblinNinja)par1Entity, par2, par4, par6, par8, par9);
	}
}
