...
{
	public void renderArrow(EntityMissile par1EntityMissile, double par2, double par4, double par6, float par8, float par9)
	{
		this.loadTexture("/MCE/items/missile.png");
		GL11.glPushMatrix();
		...
		float var21 = par1EntityMissile.arrowShake - par9;
	...
	{
		this.renderArrow((EntityMissile)par1Entity, par2, par4, par6, par8, par9);
	}
}
