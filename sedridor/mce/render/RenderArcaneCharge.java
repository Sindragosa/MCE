...
public class RenderArcaneCharge extends Render
{
	private float scale = 0.8F;

	public RenderArcaneCharge()
	{
	}

	public RenderArcaneCharge(float par1)
	{
		this.scale = par1;
	}

	public void doRenderArcaneCharge(EntityArcaneCharge par1EntityArcaneCharge, double par2, double par4, double par6, float par8, float par9)
	{
		GL11.glPushMatrix();
		...
		Icon var11 = MCEnhancements.arcaneCharge.getIconFromDamage(0);
	...
	{
		this.doRenderArcaneCharge((EntityArcaneCharge)par1Entity, par2, par4, par6, par8, par9);
	}
}
