...
public class RenderGoblinRanger extends RenderLiving
{
	...
	public RenderGoblinRanger(ModelGoblinRanger par1ModelGoblinRanger, float par2)
	{
		super(par1ModelGoblinRanger, par2);
		this.modelBipedMain = par1ModelGoblinRanger;
	}

	public void render(EntityGoblinRanger par1EntityGoblinRanger, double par2, double par4, double par6, float par8, float par9)
	{
		super.doRenderLiving(par1EntityGoblinRanger, par2, par4, par6, par8, par9);
	}

	@Override
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
	{
		this.render((EntityGoblinRanger)par1EntityLiving, par2, par4, par6, par8, par9);
	}
	...
	{
		this.render((EntityGoblinRanger)par1Entity, par2, par4, par6, par8, par9);
	}
}
