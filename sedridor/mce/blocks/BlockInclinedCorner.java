...
public class BlockInclinedCorner extends Block
{
	...
	public BlockInclinedCorner(int par1, Block par2Block)
	{
	...
	{
		return MCE_Items.inclinedCornerModelID;
	}
	...
	public Icon getIcon(int par1, int par2)
	{
		...
		Block modelBlock = MCE_Items.models[this.blockID - MCE_Items.FIRST_BLOCKID - MCE_Items.BLOCKID_DISPLACEMENT - 160];
		int modelMeta = MCE_Items.modelsMeta[this.blockID - MCE_Items.FIRST_BLOCKID - MCE_Items.BLOCKID_DISPLACEMENT - 160];
	...
	public float getExplosionResistance(Entity par1Entity, World par2World, int par3, int par4, int par5)
	{
		...
		Block modelBlock = MCE_Items.models[(blockID - MCE_Items.FIRST_BLOCKID - MCE_Items.BLOCKID_DISPLACEMENT - 160)];
		if (modelBlock != null)
		{
	...
	public void addCollisionBoxesToList(World par1World, int par2, int par3, int par4, AxisAlignedBB par5AxisAlignedBB, List par6List, Entity par7Entity)
	{
		...
		if (var9 == 0)
		{
			this.setBlockBounds(0.0F, var41, 0.0F, var43, var42, var43);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
			this.setBlockBounds(0.0F, var42, 0.0F, var42, var43, var42);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
			this.setBlockBounds(0.0F, var43, 0.0F, var41, var44, var41);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
		}
		else if (var9 == 1)
		{
			this.setBlockBounds(0.0F, var41, var41, var43, var42, 1.0F);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
			this.setBlockBounds(0.0F, var42, var42, var42, var43, 1.0F);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
			this.setBlockBounds(0.0F, var43, var43, var41, var44, 1.0F);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
		}
		else if (var9 == 2)
		{
			this.setBlockBounds(var41, var41, var41, 1.0F, var42, 1.0F);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
			this.setBlockBounds(var42, var42, var42, 1.0F, var43, 1.0F);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
			this.setBlockBounds(var43, var43, var43, 1.0F, var44, 1.0F);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
		}
		else if (var9 == 3)
		{
			this.setBlockBounds(var41, var41, 0.0F, 1.0F, var42, var43);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
			this.setBlockBounds(var42, var42, 0.0F, 1.0F, var43, var42);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
			this.setBlockBounds(var43, var43, 0.0F, 1.0F, var44, var41);
			super.addCollisionBoxesToList(par1World, par2, par3, par4, par5AxisAlignedBB, par6List, par7Entity);
		}
