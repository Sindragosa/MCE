...
public class EntityViking extends EntityMobMCE
{
	/** The ItemStack that any Viking holds (an axe). */
	private static final ItemStack defaultHeldItem = new ItemStack(Item.axeIron, 1);

	public EntityViking(World par1World)
	{
		super(par1World);
		this.texture = "/MCE/mobs/Viking2.png";
    ...
    public String getTexture()
    {
        ...
        if (var1 == 0)
        {
            return "/MCE/mobs/Viking2.png";
        }
        else
        {
            return "/MCE/mobs/Viking.png";
        }
    }*/
	...
	protected void dropRareDrop(int par1)
	{
		...
		case 1:
			this.dropItem(MCE_Items.MithrilAxe.itemID, 1);
			break;
		}
	}
