...
public class EntityArcaneCharge extends Entity implements IProjectile
{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityArcaneCharge(World par1World)
	{
		super(par1World);
	...
	public EntityArcaneCharge(World par1World, double par2, double par4, double par6)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	/*public EntityArcaneCharge(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
	...
	public EntityArcaneCharge(World par1World, EntityLiving par2EntityLiving, float par3)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLiving;
	...
	public void onUpdate()
	{
		...
		if (this.inGround || this.ticksInAir > 200)
		{
			int var18 = this.worldObj.getBlockId(this.xTile, this.yTile, this.zTile);
			int var19 = this.worldObj.getBlockMetadata(this.xTile, this.yTile, this.zTile);

			if ((var18 == this.inTile && var19 == this.inData) || this.ticksInAir > 200)
			{
				for (int var29 = 0; var29 < 32; ++var29)
				{
					this.worldObj.spawnParticle("magicImpact", this.posX, this.posY + this.rand.nextDouble() * 1.0D, this.posZ, this.rand.nextGaussian() / 2.0D, 0.0D, this.rand.nextGaussian() / 2.0D);
				}
				this.setDead();
			}
			else
		...
		else
		{
			...
			if (var4 != null)
			{
				if (var4.entityHit != null)
				{
					...
					{
						var22 = DamageSource.causeIndirectMagicDamage(this, this);
					}
					else
					{
						var22 = DamageSource.causeIndirectMagicDamage(this, this.shootingEntity);
					}
					...
					for (int var29 = 0; var29 < 32; ++var29)
					{
						this.worldObj.spawnParticle("magicImpact", this.posX, this.posY + this.rand.nextDouble() * 2.0D, this.posZ, this.rand.nextGaussian() / 2.0D, 0.0D, this.rand.nextGaussian() / 2.0D);
					}
					...
					if (var4.entityHit.attackEntityFrom(var22, var24))
					{
						if (var4.entityHit instanceof EntityLiving)
						{
							...
							if (var4.entityHit instanceof EntityMobMCE)
							{
								EntityMobMCE var28 = (EntityMobMCE)var4.entityHit;
								var28.onImpact(this);
							}
						...
						this.worldObj.playSoundAtEntity(this, "appear", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 1.0F));
