...
public class EntityPirate extends EntityMobMCE
{
	/** The ItemStack that any Pirate holds (a cutlass). */
	private static final ItemStack defaultHeldItem = new ItemStack(MCE_Items.Cutlass, 1);

	public EntityPirate(World par1World)
	{
		super(par1World);
		this.texture = "/MCE/mobs/Pirate.png";
	...
	protected void dropFewItems(boolean par1, int par2)
	{
		...
		{
			//this.dropItem(MCE_Items.Cutlass.shiftedIndex, 1);
		}
	...
	protected void dropRareDrop(int par1)
	{
		...
		{
		case 0:
			this.dropItem(MCE_Items.Cutlass.itemID, 1);
			break;
