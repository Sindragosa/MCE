...
public class EntityCrusader extends EntityMobMCE
{
	/** The ItemStack that any Crusader holds (a sword). */
	private static final ItemStack defaultHeldItem = new ItemStack(Item.swordIron, 1);

	public EntityCrusader(World par1World)
	{
		super(par1World);
		this.texture = "/MCE/mobs/Crusader.png";
		...
		this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityZombie.class, 16.0F, 0, false));
		this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityBandit.class, 16.0F, 0, false));
		this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntitySkeleton.class, 16.0F, 0, false));
	}
	...
	protected void dropRareDrop(int par1)
	{
		...
		{
		case 0:
			this.dropItem(MCE_Items.AdamantiumHelmet.itemID, 1);
			break;

		case 1:
			this.dropItem(MCE_Items.AdamantiumBoots.itemID, 1);
			break;
		}
	}
