...
public class EntityHumanFemale extends EntityMobMCE
{
	...
	public EntityHumanFemale(World par1World)
	{
		super(par1World);
		this.texture = this.getModelTexture();
		this.moveSpeed = 0.28F;
		this.tasks.addTask(1, new EntityAISwimming(this));
		//this.tasks.addTask(2, new EntityAIArrowAttack_MCE(this, this.moveSpeed, 1, 60));
	...
	public String getTexture()
	{
		...
		if (var1 == 0)
		{
			return "/MCE/mobs/New/HumanFemale2.png";
		}
		else
		{
			return "/MCE/mobs/New/HumanFemale.png";
		}
	}
