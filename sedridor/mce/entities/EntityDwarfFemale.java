...
public class EntityDwarfFemale extends EntityMobMCE
{
	...
	public EntityDwarfFemale(World par1World)
	{
		super(par1World);
	 ...
	 */
	 ...
	 public String getTexture()
	 {
		 ...
		 if (var1 == 0)
		 {
			 return "/MCE/mobs/New/DwarfFemale2.png";
		 }
		 else
		 {
			 return "/MCE/mobs/New/DwarfFemale.png";
		 }
	 }
