...
public class EntityGladiator extends EntityMobMCE
{
	/** The ItemStack that any Gladiator holds (a runite sword). */
	private static final ItemStack defaultHeldItem = new ItemStack(MCE_Items.RuniteSword, 1);

	public EntityGladiator(World par1World)
	{
		super(par1World);
		this.texture = "/MCE/mobs/Gladiator.png";
	...
	{
		return MCE_Items.MithrilSword.itemID;
	}
