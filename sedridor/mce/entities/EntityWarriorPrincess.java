...
public class EntityWarriorPrincess extends EntityMobMCE
{
	/** The ItemStack that any Warrior Princess holds (a sword). */
	private static final ItemStack defaultHeldItem = new ItemStack(MCE_Items.MithrilSword, 1);

	public EntityWarriorPrincess(World par1World)
	{
		super(par1World);
		this.texture = "/MCE/mobs/WarriorPrincess.png";
	...
	{
		return MCE_Items.MithrilIngot.itemID;
	}
	...
	protected void dropRareDrop(int par1)
	{
		...
		case 1:
			this.dropItem(MCE_Items.MithrilLegs.itemID, 1);
			break;
		}
	}
