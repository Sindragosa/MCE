...
public class EntityElfMale extends EntityMobMCE
{
	/** The ItemStack that any Elf holds (a bow). */
	private static final ItemStack defaultHeldItem = new ItemStack(MCE_Items.AdamantiumBow, 1);

	public EntityElfMale(World par1World)
	{
		super(par1World);
	 ...
	 */
	 ...
	 public String getTexture()
	 {
		 ...
		 if (var1 == 0)
		 {
			 return "/MCE/mobs/New/ElfMale2.png";
		 }
		 else
		 {
			 return "/MCE/mobs/New/ElfMale.png";
		 }
	 }
	 ...
	 protected void dropRareDrop(int par1)
	 {
		 if (par1 > 0)
		 {
			 ItemStack var2 = new ItemStack(MCE_Items.AdamantiumBow);
