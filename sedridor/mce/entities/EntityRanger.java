...
public class EntityRanger extends EntityMobMCE
{
	/** The ItemStack that any Ranger holds (a bow). */
	private static final ItemStack defaultHeldItem = new ItemStack(Item.bow, 1);

	public EntityRanger(World par1World)
	{
		super(par1World);
		this.texture = "/MCE/mobs/Ranger.png";
	...
	protected void dropRareDrop(int par1)
	{
		if (par1 > 0)
		{
			...
			EnchantmentHelper.addRandomEnchantment(rand, var2, 5);
