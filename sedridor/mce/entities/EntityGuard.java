...
public class EntityGuard extends EntityMobMCE
{
	/** The ItemStack that any Guard holds (a gold sword). */
	...
	{
		super(par1World);
		this.texture = "/MCE/mobs/Guard.png";
	...
	{
		return MCE_Items.AdamantiumIngot.itemID;
	}
	...
	protected void dropFewItems(boolean par1, int par2)
	{
		...
		var3 = this.rand.nextInt(3) + 1 + rand.nextInt(1 + par2);
	}
