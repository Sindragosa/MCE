...
public class EntitySamurai extends EntityMobMCE
{
	/** The ItemStack that any Samurai holds (a sword). */
	private static final ItemStack defaultHeldItem = new ItemStack(MCE_Items.KatanaSword, 1);

	public EntitySamurai(World par1World)
	{
		super(par1World);
		this.texture = "/MCE/mobs/Samurai.png";
	...
	{
		return MCE_Items.SteelIngot.itemID;
	}
