...
public class EntityMinotaur extends EntityMobMCE
{
	/** The ItemStack that any Minotaur holds (an axe). */
	private static final ItemStack defaultHeldItem = new ItemStack(Item.axeIron, 1);

	public EntityMinotaur(World par1World)
	{
		super(par1World);
		this.texture = "/MCE/mobs/Minotaur.png";
		...
		this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 16F, 0, true));
		this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityVillager.class, 16F, 0, false));
	}
