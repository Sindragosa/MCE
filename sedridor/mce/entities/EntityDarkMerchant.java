...
public class EntityDarkMerchant extends EntityMobMCE
{
	/** The ItemStack that any Dark Merchant holds (a sword). */
	private static final ItemStack defaultHeldItem = new ItemStack(MCE_Items.AdamantiumSword, 1);

	public EntityDarkMerchant(World par1World)
	{
		super(par1World);
		this.texture = "/MCE/mobs/DarkMerchant.png";
	...
	public boolean interact(EntityPlayer entityplayer)
	{
		...
		{
			entityplayer.inventory.setInventorySlotContents(entityplayer.inventory.currentItem, new ItemStack(MCE_Items.AdamantiumSword)); // MysticSword
			return true;
		}
		else
		{
