...
public class EntityMerchant extends EntityMobMCE
{
	/** The ItemStack that any Merchant holds (a book). */
	private static final ItemStack defaultHeldItem = new ItemStack(Item.book, 1);

	public EntityMerchant(World par1World)
	{
		super(par1World);
		this.texture = "/MCE/mobs/Merchant.png";
	...
	public void onLivingUpdate()
	{
		if (this.worldObj.isDaytime() && !this.worldObj.isRemote)
		{
			...
			{
				if (rand.nextFloat() * 30.0F >= (var1 - 0.4F) * 2.0F) {
					;
				}
			}
		}
	...
	public boolean interact(EntityPlayer entityplayer)
	{
		...
		if (var2 != null && var2.itemID == Item.ingotGold.itemID)
		{
	...
	public boolean getCanSpawnHere()
	{
		...
		return this.getSpawnRarity(1) && this.worldObj.checkNoEntityCollision(this.boundingBox) && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox).isEmpty() && !this.worldObj.isAnyLiquid(this.boundingBox) && this.worldObj.getFullBlockLightValue(var1, var2, var3) > 8;
	}
}
