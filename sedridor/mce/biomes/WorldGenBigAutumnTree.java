...
public class WorldGenBigAutumnTree extends WorldGenerator
{
	...
	public WorldGenBigAutumnTree(boolean doNotify, int leafMeta, int woodMeta)
	{
		super(doNotify);
	...
	public WorldGenBigAutumnTree(boolean doNotify, int leaf, int leafMeta, int wood, int woodMeta)
	{
		super(doNotify);
		this.leaf = leaf;
		this.wood = wood;
	...
	void genTreeLayer(int par1, int par2, int par3, float leafSize)
	{
		int var7 = (int)(leafSize + 0.618D);
		byte var8 = otherCoordPairs[1];
		byte var9 = otherCoordPairs[4];
		int[] var10 = new int[] {par1, par2, par3};
		int[] var11 = new int[] {0, 0, 0};
		int var12 = -var7;
		int var13 = -var7;

		for (var11[1] = var10[1]; var12 <= var7; ++var12)
		{
			...
			while (var13 <= var7)
			{
				...
				else
				{
					...
					int id = this.worldObj.getBlockId(var11[0], var11[1], var11[2]);
					...
					{
						this.setBlockAndMetadata(this.worldObj, var11[0], var11[1], var11[2], this.leaf, this.leafMeta);
						++var13;
					}
				}
			}
	...
	{
		return distanceFromNode >= 0 && distanceFromNode < this.leafDistanceLimit ? (distanceFromNode != 0 && distanceFromNode != this.leafDistanceLimit - 1 ? 3.0F : 2.0F) : -1.0F;
	}
	...
	void generateLeafNode(int par1, int par2, int par3)
	{
		...
		for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4)
		{
			...
			this.genTreeLayer(par1, var4, par3, var6);
		}
	}
	...
	void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
	{
		...
		if (var4[var6] != 0)
		{
			...
			for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
			{
				...
				Block block = Block.blocksList[worldObj.getBlockId(var14[0], var14[1], var14[2])];
				if (block == null || this.worldObj.getBlockId(var14[0], var14[1], var14[2]) == Block.leaves.blockID)
				{
					this.setBlockAndMetadata(worldObj, var14[0], var14[1], var14[2], this.wood, this.woodMeta);
				}
			}
		}
	}
	...
	int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
	{
		...
		else
		{
			...
			for (var15 = var3[var5] + var8; var14 != var15; var14 += var8)
			{
				...
				int id = this.worldObj.getBlockId(var13[0], var13[1], var13[2]);
