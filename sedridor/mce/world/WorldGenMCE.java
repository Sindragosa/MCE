...
public class WorldGenMCE implements IWorldGenerator
{
	...
	public void generateSurface(World par1World, Random par2Random, int chunkX, int chunkZ)
	{
		...
		{
			this.generateOres(MCE_Items.RuniteOre.blockID, 7, 1, 16, par1World, par2Random, chunkX, chunkZ);
		}
		if (this.generateDragonite)
		{
			this.generateOres(MCE_Items.DragoniteOre.blockID, 2, 1, 16, par1World, par2Random, chunkX, chunkZ);
		}
		...
		{
			this.generateOres(MCE_Items.TitaniumOre.blockID, 7, 1, 16, par1World, par2Random, chunkX, chunkZ);
		}
		/*if (this.generateElementium)
        {
        	this.generateOres(MCE_Items.ElementiumOre.blockID, 2, 1, 16, par1World, par2Random, chunkX, chunkZ);
        }*/
	}
	/**
