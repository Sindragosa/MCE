...
public class ExplosionMCE extends Explosion
{
	...
	public ExplosionMCE(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9, float par11)
	{
		super(par1World, par2Entity, par3, par5, par7, par9);
		this.worldObj = par1World;
		this.exploder = par2Entity;
		this.explosionSize = par9;
		this.explosionForce = par11;
	...
	public void doExplosionA()
	{
					...
					if (var3 == 0 || var3 == this.field_77289_h - 1 || var4 == 0 || var4 == this.field_77289_h - 1 || var5 == 0 || var5 == this.field_77289_h - 1)
					{
						...
						for (float var21 = 0.3F; var14 > 0.0F; var14 -= var21 * 0.75F)
						{
							...
							if (var25 > 0)
							{
								...
								// ------------------------------------------------ MCE
								//var14 -= (var26.getExplosionResistance(this.exploder, this.worldObj, var22, var23, var24) + 0.3F) * var21;
								// ------------------------------------------------ MCE
		...
		for (int var11 = 0; var11 < var9.size(); ++var11)
		{
			...
			if (var13 <= 1.0D)
			{
				...
				var17 = var32.posY + var32.getEyeHeight() - this.explosionY;
				...
				if (var34 != 0.0D)
				{
					...
					var32.attackEntityFrom(DamageSource.setExplosionSource(this), (int)((var35 * var35 + var35) / 2.0D * 8.0D * (this.explosionSize * this.explosionForce) + 1.0D)); // MCE
		...
		if (this.isSmoking)
		{
			...
			while (var2.hasNext())
			{
				...
				if (par1)
				{
					...
					var16 /= var20;
					var18 /= var20;
					double var22 = 0.5D / (var20 / (this.explosionSize * this.explosionForce) + 0.1D); // MCE
				...
				if (var7 > 0 && (this.destroyBlocks || var7 == Block.snow.blockID || var7 == Block.ice.blockID || var7 == Block.blockSnow.blockID)) // MCE
				{
